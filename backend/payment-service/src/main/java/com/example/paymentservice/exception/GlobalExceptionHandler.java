...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(EstimateClaimException.class)
    public ResponseEntity<ErrorResponse> handleEstimateClaimException(
            EstimateClaimException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ErrorResponse> handlePaymentProviderNotConfiguredException(
